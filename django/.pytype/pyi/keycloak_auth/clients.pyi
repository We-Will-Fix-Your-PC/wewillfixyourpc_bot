...
from typing import Any, Container, Mapping, Tuple, TypeVar, Union
...
def _update_or_create(token_response: Union[Container, Mapping[str, Any]], initiate_time) -> Any: ...
...
def update_or_create_user_and_oidc_profile(id_token_object: Mapping[str, Any]) -> Any: ...
def update_tokens(token_model: _T0, token_response: Mapping[str, Any], initiate_time) -> _T0: ...
