...
def create_models(apps, objects, brand):
    ...
    for repair in objects:
        try:
            ...
            model = Model(brand=brand, name=repair.name.lower(), display_name=repair.name)
            model.save()
        try:
            repair_type = RepairType.objects.get(name=repair.repair_name.lower())
        except RepairType.DoesNotExist:
            repair_type = RepairType(name=repair.repair_name.lower(), display_name=repair.repair_name)
            repair_type.save()
        new_repair = Repair(price=repair.price, repair_time=repair.repair_time, device=model,
                            repair=repair_type)
        new_repair.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('fulfillment', '0009_auto_20190803_0828'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fulfillment.Model')),
                ('repair', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fulfillment.RepairType')),
            ],
        ),
        ...
        migrations.AlterField(
            ...
            name='device',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fulfillment.Model'),
        ),
    ]
