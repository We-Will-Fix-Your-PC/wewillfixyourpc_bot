...
def opening_hours(params, _):
    ...
    if want_date_period is not None and want_date_period != "":
        ...
        return {
            "fulfillmentText": f"Our opening hours are:\n{days}\n{future_overrides_txt}",
        }
...
def contact_email(_, text: str):
    ...
    return {
        "fulfillmentText": text.replace("$email", contact_details.email)
    }
...
def contact_phone(_, text: str):
    ...
    return {
        "fulfillmentText": text.replace("$phone", contact_details.phone_number.as_national)
    }
...
def location(_, text: str):
    ...
    return {
        "fulfillmentText": text.replace("$link", contact_details.maps_link)
    }
